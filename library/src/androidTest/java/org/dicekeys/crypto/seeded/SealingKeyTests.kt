...
//    }
    ...
    fun createPublicKeyFromJson() {
        ...
        assertEquals(recipeJson, pk.recipe)
        val copyOfPk = SealingKey(pk.keyBytes, pk.recipe)
    ...
    fun createSignatureVerificationKeyFromJson() {
        ...
        assertEquals(recipeJson, svk.recipe)
        val copyOfSvk = SignatureVerificationKey(svk.keyBytes, svk.recipe)
    ...
    fun testSymmetricKey() {
        ...
        assertEquals(copy.recipe, sk.recipe)
    ...
    fun testSeed() {
        ...
        assertEquals(copy.recipe, s.recipe)
    }
